import { Platform, AdapterEvents } from "./adapters";
...
export class MtcHost {
  ...
  constructor(config?: MtcConfig) {
    ...
    this.panel = new PanelRunner(this.socket, config?.panel);
    if (!config?.disableStatementLogging) {
      ...
      console.log(
        " " +
          readFileSync(import.meta.dir + "/Chiissu")
            .toString()
            .replaceAll("\n", "\n "),
      );
      console.log(
        " Copyright 2023 by Chiissu team. All rights reserved. Any\n unauthorised distribution of this software may and will\n result in legal action.",
      );
      console.log(
        "===============================================================",
      );
